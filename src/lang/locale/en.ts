...
export default <LangMap>{
  ...
  "存储模式": "Storage Mode",
  "选择图片上传的目标存储": "Select target storage for image uploads",
  "多吉云": "DogeCloud",
  "AccessKey ID": "AccessKey ID",
  "多吉云 AccessKey ID": "DogeCloud AccessKey ID",
  "输入 AccessKey ID": "Enter AccessKey ID",
  "AccessKey Secret": "AccessKey Secret",
  "多吉云 AccessKey Secret": "DogeCloud AccessKey Secret",
  "输入 AccessKey Secret": "Enter AccessKey Secret",
  "Bucket 名称": "Bucket Name",
  "存储桶名称": "Storage bucket name",
  "Endpoint": "Endpoint",
  "S3 兼容端点地址": "S3 compatible endpoint URL",
  "Region": "Region",
  "区域,如 ap-shanghai": "Region, e.g. ap-shanghai",
  "自定义路径": "Custom Path",
  "存储路径前缀,如 images/obsidian": "Storage path prefix, e.g. images/obsidian",
  "访问URL前缀": "Access URL Prefix",
  "CDN或访问域名,如 https://cdn.example.com": "CDN or access domain, e.g. https://cdn.example.com",
  "上传失败:": "Upload failed:",
