...
export default <LangMap>{
  ...
  "上传速度优化 - 输出格式": "Upload speed optimization - Output format",
  "压缩后的图片格式,WebP格式压缩效果最好": "The output format of the compressed image, WebP format has the best compression",
